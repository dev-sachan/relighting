...
# ---------------- SKIN ----------------
def apply_skin(objs):
    mat = bpy.data.materials.get("SkinAI") or bpy.data.materials.new("SkinAI")
    mat.use_nodes = True
    ...
    ramp.color_ramp.elements[0].color = (0.85, 0.6, 0.5, 1)
    ramp.color_ramp.elements[1].color = (0.95, 0.75, 0.65, 1)
